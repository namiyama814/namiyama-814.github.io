...
export const homeCopy: Record<Locale, HomeCopy> = {
  ja: {
    ...
    aboutLead: 'アイデアを形にするだけでなく、使う人が迷わず前に進めることまで考えて設計と実装を行っています。',
    qualities: [
      { title: '考える', descriptionLines: ['複雑な情報や課題を整理し', '必要な体験を見つけます。'] },
      { title: '設計する', descriptionLines: ['目的と使う人をつなぐ', 'わかりやすい流れを組み立てます。'] },
      { title: '実装する', descriptionLines: ['Webサイトやツールとして、', '実際に動く形まで落とし込みます。'] },
    ],
  ...
  en: {
    ...
    qualities: [
      { title: 'Think', descriptionLines: ['Organize complex information', 'and uncover the right experience.'] },
      { title: 'Design', descriptionLines: ['Connect goals with people', 'through clear, useful flows.'] },
      { title: 'Build', descriptionLines: ['Turn ideas into working websites', 'and practical tools.'] },
    ],
...
export const timeline: Array<{
  ...
  { date: '2026.04', organization: '角川ドワゴ学園 S高等学校', role: { ja: '入学', en: 'Enrolled' }, href: 'https://nnn.ed.jp' },
